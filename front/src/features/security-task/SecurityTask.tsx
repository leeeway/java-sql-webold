...
interface SecurityTaskState {
  loading: boolean;
  submitting: boolean;
  otpSessionLoading: boolean;
  taskInfo: SecurityTaskInfo | null;
  password: string;
...
const initialState: SecurityTaskState = {
  loading: true,
  submitting: false,
...
function SecurityTask() {
  ...
  const [state, setState] = useState<SecurityTaskState>(initialState);
